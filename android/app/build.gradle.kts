...
android {
    ...
    buildTypes {
        release {
            ...
            // (crash: "Didn't find class ...MainActivity") and breaks
            // WorkManager/Room reflective instantiation ("Failed to create an
            // instance of ...WorkDatabase"). Dart code is already AOT-optimized.
